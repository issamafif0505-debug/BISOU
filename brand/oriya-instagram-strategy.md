...
## 1️⃣ BIO INSTAGRAM BUSINESS

### BIO PRINCIPALE (Version Courte - 150 caractères max)
```
✨ BIJOUX PLAQUÉS OR 💛
Acier 316L • Anti-allergique • Made with Love
📲 Commande en DM
👇 Lien en bio
```
...
## 2️⃣ HASHTAGS STRATÉGIQUES (40 Tags)
...
| Hashtag | Volume | Priorité |
|---------|--------|----------|
| #bijouxplaquéor | Moyen | ⭐⭐⭐ |
| #colliersor | Moyen | ⭐⭐⭐ |
| #bracelets | Moyen | ⭐⭐⭐ |
| #bagues | Petit | ⭐⭐⭐ |
| #orplaqué | Moyen | ⭐⭐ |
| #acier316l | Petit | ⭐⭐ |
| #bijouxantialergique | Petit | ⭐⭐⭐ |
| #bijouxantipeau | Petit | ⭐⭐ |

### 👑 HASHTAGS AUDIENCE (Lifestyle)
| Hashtag | Volume | Priorité |
|---------|--------|----------|
| #bijouxfemme | Gros | ⭐⭐⭐ |
| #femininité | Gros | ⭐⭐⭐ |
| #luxeaccessible | Moyen | ⭐⭐⭐ |
| #fashionbijou | Moyen | ⭐⭐⭐ |
| #stylefeminin | Gros | ⭐⭐⭐ |
| #minimalistejewelry | Moyen | ⭐⭐ |
| #bijouxpourelles | Petit | ⭐⭐⭐ |
| #accessoiresfemme | Moyen | ⭐⭐ |
...
### 📸 HASHTAGS CONTENU (Format)
| Hashtag | Volume | Priorité |
|---------|--------|----------|
| #unboxing | Moyen | ⭐⭐⭐ |
| #behindthescenes | Moyen | ⭐⭐⭐ |
| #smallbusiness | Moyen | ⭐⭐⭐ |
| #madewithlove | Moyen | ⭐⭐⭐ |

**STRATÉGIE D'USAGE :**
- **Posts classiques :** 20-25 hashtags (mix petit/moyen/gros)
- **Reels :** 30-35 hashtags (accent sur tendance)
- **Stories :** 10-12 hashtags (+ call-to-action)

---

## 3️⃣ CONTENUS 9 PREMIERS POSTS (3 Semaines)
...
#### 🎬 **JOUR 1 — LANCEMENT OFFICIEL (Lundi)**
```
...
#### 🎁 **JOUR 3 — UNBOXING EXPERIENCE (Mercredi)**
```
...
#### 💬 **JOUR 5 — TÉMOIGNAGE CLIENT #1 (Vendredi)**
```
...
#### 🔗 **JOUR 8 — SPOTLIGHT PRODUIT: COLLIERS (Lundi)**
```
...
- Chaque slide en lifestyle + gros plan détail
- Text overlay: prix approx ou feature clé
```

---

#### 💅 **JOUR 10 — SPOTLIGHT PRODUIT: BAGUES (Mercredi)**
```
...
- Close-up main portant bague
- Détails gravure si applicable
```

---

#### 📦 **JOUR 12 — SPOTLIGHT PRODUIT: BRACELETS (Vendredi)**
```
...
- Different styles (chaîne, perles, minimaliste)
- Lifestyle: main, poignet en focus
```
...
#### 🎨 **JOUR 15 — BEHIND THE SCENES: PROCESS ARTISANAL (Lundi)**
```
...
- Close-up mains artisan au travail
- Warm/naturel lighting
```

---

#### 🌟 **JOUR 17 — TÉMOIGNAGE CLIENT #2 + PROMO (Mercredi)**
```
Thème: Social Proof + First-Time Buyer Offer
Caption:
"Asmaa a osé essayer → elle en a commandé 3 de plus 😍
'C'est mon secret luxe local!' — Asmaa, Marrakech
...
- Customer photo (avec permission)
- Color pop: or/noir/crème avec accent rouge "PROMO"
```

---

#### 🚀 **JOUR 19 — TREND REPRISE: "GET READY WITH ME" (Vendredi)**
```
...
## 4️⃣ STORIES TEMPLATES (3 Modèles)

### 🎬 **TEMPLATE 1: UNBOXING / RÉVÉLATION PRODUIT**
...
[SLIDE 2]
Action: Mains ouvrent la boîte lentement
Music: Satisfying unboxing sound
Text: "3... 2... 1... ✨"

[SLIDE 3]
Visual: Bijou revealed, close-up
Text: "C'est C'EST TROP BEAU! 💛"
Sticker: Heart reaction

[SLIDE 4]
CTA: "Ton tour? 📲 Clique ici ou WhatsApp"
Link: Bio link vers boutique
Sticker: Shopping bag / CTA button

[SLIDE 5]
Visual: Customer wearing product
Text: "C'est comme ça que ça rend..."
Sticker: "Seen" interaction
```
...
### 💬 **TEMPLATE 2: TESTIMONIAL / AVIS CLIENT**
...
[SLIDE 1]
Header: "On vous lit... 👂💛"
Visual: DM screenshot (anonyme ou avec permission)
Text: "Jessica nous a écrit ce matin..."

[SLIDE 2]
Visual: Full testimony
Quote: "[Avis client long: 'J'ai commandé pour tester...' etc]"
Font: Cream/Or sur fond noir luxe
Sticker: Testimonial/Quote badge
...
[SLIDE 4]
Visual: Produit en gros plan
Text: "Disponible en 4 couleurs"
Sticker: "SHOP NOW" link

[SLIDE 5]
CTA: "Partage TA review! Réponds à cette story 👇"
Sticker: Reply message
```

**Fréquence:** 1x/semaine (jeudi-vendredi)

---

### 💥 **TEMPLATE 3: FLASH SALE / PROMO**
...
[SLIDE 1]
Header: "⏰ ALERTE PROMO!"
Countdown: "24h seulement"
Visual: Produit en focus
Color: Red/Or accent sur noir

[SLIDE 2]
Big Text: "JUSQU'À -25% 💛"
Visual: Produit étoilé / sparkles
Sticker: Sale icon
...
[SLIDE 4]
Visual: Produits éligibles en carousel
Text: "Colliers • Bagues • Bracelets"
Sticker: "Swipe" ➡️

[SLIDE 5]
CTA: "🛒 Commande avant minuit!"
Link: Bio link ou WhatsApp
Sticker: Shopping bag + Timer

[SLIDE 6]
Visual: Last chance graphic
Text: "Plus que 3 heures! 🔥"
Urgency: Countdown sticker
```

**Fréquence:** 1-2x/mois (avant week-ends)

---

## 5️⃣ REELS IDEAS (5 Concepts Vidéo)

### 🎬 **REEL 1: PROCESS ARTISANAL (20-30 sec)**

**Concept:** "De l'idée au poignet"

```
[Timing: 5s] Intro
- Scene: Designer sketch with pen
- Text: "Tout commence par une idée ✨"
- Music: Upbeat, artisanal vibe

[Timing: 5s] Design
- Scene: Close-up hand drawing
- Text: "Nos artisans imaginent chaque détail 🎨"

[Timing: 8s] Production
- Scene: Plating/crafting in workshop
- Quick cuts: Different stages of creation
- Text: "Plaqué or 24k • Acier 316L"
- Music builds
...
[Timing: 10s] Product showcase
- Scene: Slow-mo or 360° product rotation
- Close-ups: Detail, quality, shine
- Text: "Minimaliste mais IMPACTANT 🔗"

[Timing: 4s] CTA
- Visual: Product + WhatsApp icon
- Text: "Tag someone you want to give this to 👇"
...
- Scene: Bracelet in water
- Text: "✅ Résistant eau de mer & douche"
- Visual: Water drops, no damage

[Timing: 5s] Sweat Test
- Scene: Bracelet on wrist after "workout"
- Text: "✅ OK saleté & sueur"
- Visual: Wiped clean, good as new

[Timing: 5s] Allergy Test
- Scene: Close-up skin, no reaction
- Text: "✅ Hypoallergénique GARANTI"
- Sticker: Green checkmark

[Timing: 5s] Shine Test
- Scene: Before/after polish, sparkle
- Text: "✅ Brillance éternelle après soin"

[Timing: 2s] CTA
- Text: "Garanti 6 mois | Soin offert"
- Visual: Product
...
- Camera angles: Different cuts, dynamic
- Subtitles: French text
- B-roll: Her wearing the jewelry

[Timing: 3s] Product showcase
- Visual: She shows her jewelry
- Text: "Disponible online"
- Music builds
...
- Quick scenes: Makeup application, outfit choice
- Music continues
...
**STRATÉGIE REELS:**
- Poster **1 Reel/semaine minimum** (idéalement 2)
- Publier le **Lundi, Mercredi ou Vendredi** (meilleur engagement)
- Utiliser **trending sounds** + hashtags viraux
...
## 6️⃣ COLLABORATION INFLUENCERS

### 📊 **TIERS & BUDGETS (En MAD - Dirhams Marocains)**

---

### **TIER 1: NANO-INFLUENCERS**
*5k - 15k followers*

**Budget par collaboration:** 200 - 500 MAD
...
**Fréquence:** 2-3 collabs/mois

**KPI Attendus:**
- Reach: 15k-30k
- Engagement: 3-5%
- Traffic WhatsApp: 5-10 leads
...
**Budget par collaboration:** 500 - 1500 MAD
...
**Fréquence:** 2 collabs/mois

**KPI Attendus:**
- Reach: 50k-150k per post
- Engagement: 4-7%
- Traffic WhatsApp: 20-50 leads
- Conversions: 5-15 sales
...
**Budget par collaboration:** 1500 - 5000 MAD+

**Deliverables:**
- 3 posts Instagram (mix: lifestyle, product, testimonial)
...
**Fréquence:** 1-2 collabs/trimestre

**KPI Attendus:**
- Reach: 200k-500k+ per post
- Engagement: 3-6%
- Traffic WhatsApp: 50-150 leads
- Conversions: 30-100+ sales
- Brand awareness + credibility boost
...
- ✅ Authentique (pas d'engagement fake)
- ✅ Avec présence au Maroc (followers locaux 50%+)
- ✅ Ton luxe/accessible aligné
...
- [N°] bijou(x) au choix
- Packaging premium
- Brief créatif (pas de script imposé)
...
### 🎨 **HASHTAGS COLLABORATION STRATEGY**

**Hashtags à utiliser dans CHAQUE post influencer:**
...
|---------|-----------|----------|
| **Posts** | 3x/semaine | Awareness + Engagement |
| **Reels** | 2x/semaine | Viral reach + Algorithm boost |
| **Stories** | 5-6x/semaine | Daily engagement + FOMO |
| **Collaborations** | 2-3/mois | Credibility + New audience |
| **Promo/Sales** | 1x/mois | Conversion + Revenue |

---

## 🎨 **IDENTITÉ VISUELLE INSTAGRAM**
...
**Typography:**
- Sans-serif moderne (Montserrat, Poppins)
- Élégant mais accessible

**Mood/Tone:**
- Luxe approachable
- Empowering (woman-centric)
- Artisanal + authentic
- Confiant mais warm
...
- Celebrate feminity & individuality
- Push local Moroccan pride

---

## 💡 **QUICK WIN ACTIONS (First 30 Days)**

1. ✅ Optimiser bio + lien en bio (Linktree ou boutique)
2. ✅ Publier 9 posts sur 3 semaines (calendrier ci-dessus)
3. ✅ Créer Stories templates (daily)
